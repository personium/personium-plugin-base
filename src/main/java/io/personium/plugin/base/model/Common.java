 ...
 */
package io.personium.plugin.base.model;
...
public class Common {
     ...
     * DC名前空間.
     */
    public static final PrefixedNamespace DC_NAMESPACE = new PrefixedNamespace(PluginUtils.XmlConst.NS_DC1,
            PluginUtils.XmlConst.NS_PREFIX_DC1);
