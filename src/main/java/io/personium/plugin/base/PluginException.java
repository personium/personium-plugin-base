...
public class PluginException extends Exception {
    ...
    /** Plugin custom error code. */
    private String customErrorCode;
    /** Plugin custom severity. */
    private Severity customSeverity;
    ...
    public static class NetWork extends PluginException {
        ...
        /**
         * NetWork PluginException factory.
         * @param customErrorCode error code
         * @param customSeverity severity
         * @param customMessage message
         * @param customStatus status
        ...
        public static PluginException.NetWork create(
                ...
                final Throwable t) {
            return new PluginException.NetWork(
                    customErrorCode, customSeverity, customMessage, customStatus, oauthError, t);
        }
    ...
    public static class Auth extends PluginException {
         ...
         * リクエストパラメータが不正.
         */
        public static final PluginException REQUEST_PARAM_INVALID =
                new PluginException(PLUGIN_TYPE_REQUEST_PARAM_INVALID);
        /**
         * パスワード文字列が不正.
         */
        public static final PluginException P_CREDENTIAL_REQUIRED =
                new PluginException(PLUGIN_TYPE_P_CREDENTIAL_REQUIRED);

        /**
         * ユニットユーザアクセスではない.
         */
        public static final PluginException UNITUSER_ACCESS_REQUIRED =
                new PluginException(PLUGIN_TYPE_UNITUSER_ACCESS_REQUIRED);
        /**
         * 必要な権限が無い.
         */
        public static final PluginException NECESSARY_PRIVILEGE_LACKING =
                new PluginException(PLUGIN_TYPE_NECESSARY_PRIVILEGE_LACKING);
        /**
         ...
         * スキーマ認証が必要.
         */
        public static final PluginException SCHEMA_AUTH_REQUIRED =
                new PluginException(PLUGIN_TYPE_SCHEMA_AUTH_REQUIRED);
        /**
         * このスキーマ認証ではアクセスできない.
         */
         ...
         * スキーマ認証レベルが不足.
         */
        public static final PluginException INSUFFICIENT_SCHEMA_AUTHZ_LEVEL =
                new PluginException(PLUGIN_TYPE_INSUFFICIENT_SCHEMA_AUTHZ_LEVEL);
        /**
         * ルートCA証明書の設定エラー.
         */
        public static final PluginException ROOT_CA_CRT_SETTING_ERROR =
                new PluginException(PLUGIN_TYPE_ROOT_CA_CRT_SETTING_ERROR);
        /**
         * リクエストパラメータが不正.
         */
        public static final PluginException REQUEST_PARAM_CLIENTID_INVALID =
                new PluginException(PLUGIN_TYPE_REQUEST_PARAM_CLIENTID_INVALID);
        /**
         * リクエストパラメータが不正.
         */
        public static final PluginException REQUEST_PARAM_REDIRECT_INVALID =
                new PluginException(PLUGIN_TYPE_REQUEST_PARAM_REDIRECT_INVALID);
        /**
         * IdTokenが不正.
         */
        public static final PluginException IDTOKEN_ENCODED_INVALID =
                new PluginException(PLUGIN_TYPE_IDTOKEN_ENCODED_INVALID);
        ...
        public static PluginException.Auth create(
                ...
                final String oauthError,
                final Throwable t) {
            return new PluginException.Auth(
                    customErrorCode, customSeverity, customMessage, customStatus, oauthError, t);
        }
    ...
    public static class Authn extends PluginException {
         ...
         * Grant-Typeの値が異常.
         */
        public static final PluginException UNSUPPORTED_GRANT_TYPE =
                new PluginException(PLUGIN_TYPE_UNSUPPORTED_GRANT_TYPE);
        /**
         * トークンパースエラー.
         */
         ...
         * {0}:パラメータキー名
         */
        public static final PluginException REQUIRED_PARAM_MISSING =
                new PluginException(PLUGIN_TYPE_REQUIRED_PARAM_MISSING);
        /**
         ...
         * 無効なIDToken.
         */
        public static final PluginException OIDC_INVALID_ID_TOKEN =
                new PluginException(PLUGIN_TYPE_OIDC_INVALID_ID_TOKEN);
        /**
         * IDTokenの有効期限切れ.
         */
        public static final PluginException OIDC_EXPIRED_ID_TOKEN =
                new PluginException(PLUGIN_TYPE_OIDC_EXPIRED_ID_TOKEN);

        /**
         * 接続先が想定外の値を返却.
         */
        public static final PluginException OIDC_UNEXPECTED_VALUE =
                new PluginException(PLUGIN_TYPE_OIDC_UNEXPECTED_VALUE);
        ...
        public static PluginException.Authn create(
                ...
                final String oauthError,
                final Throwable t) {
            return new PluginException.Authn(
                    customErrorCode, customSeverity, customMessage, customStatus, oauthError, t);
        }
    ...
    public PluginException reason(final Throwable t) {
        // クローンを作成
        PluginException ret = new PluginException(
                this.customErrorCode, this.customSeverity, this.customMessage, this.customStatus, t);
        return ret;
    }

    /**
     * メッセージをパラメタ置換したものを作成して返します. エラーメッセージ上の $1 $2 等の表現がパラメタ置換用キーワードです。
     * @param parameters 付加メッセージ
     * @return PluginException
     */
    public PluginException params(final String... parameters) {
        // メッセージ置換クローンを作成
